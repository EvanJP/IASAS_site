function scaleVideoContainer() {
    var e = $(window).height() + 5,
        t = parseInt(e) + "px";
    $(".homepage-hero-module").css("height", t)
}
...
function scaleBannerVideoSize(e) {
    var n, r, t = $(window).width(),
        i = $(window).height() + 5;
    $(e).each(function () {
        var e = $(this).data("height") / $(this).data("width");
        $(this).width(t), 1e3 > t && (r = i, n = r / e, $(this).css({
            "margin-top": 0,
            "margin-left": -(n - t) / 2 + "px"
        }), $(this).width(n).height(r)), $(".homepage-hero-module .video-container video").addClass("fadeIn animated")
    })
}

function upTo(e, t) {
    for (t = t.toLowerCase(); e && e.parentNode;)
        if (e = e.parentNode, e.tagName && e.tagName.toLowerCase() == t) return e;
    return null
}! function (e, t, i, n) {
    "use strict";
    ...
    function S(e, t) {
        ...
        this.manager = e, this.callback = t, this.element = e.element, this.target = e.options.inputTarget, this.domHandler = function (t) {
            f(e.options.enable, [e]) && i.handler(t)
        }, this.init()
    }

    function T(e) {
        var t, i = e.options.inputClass;
        return new(t = i ? i : ge ? q : ye ? H : me ? R : z)(e, O)
    }
    ...
    function O(e, t, i) {
        var n = i.pointers.length,
            ...
            a = t & Se && 0 === n - r,
            o = t & (Oe | Ee) && 0 === n - r;
        i.isFirst = !!a, i.isFinal = !!o, a && (e.session = {}), i.eventType = t, E(e, i), e.emit("hammer.input", i), e.recognize(i), e.session.prevInput = i
    }
    ...
    function E(e, t) {
        var i = e.session,
            n = t.pointers,
            r = n.length;
        i.firstInput || (i.firstInput = $(t)), r > 1 && !i.firstMultiple ? i.firstMultiple = $(t) : 1 === r && (i.firstMultiple = !1);
        var a = i.firstInput,
            o = i.firstMultiple,
            s = o ? o.center : a.center,
            l = t.center = M(n);
        t.timeStamp = pe(), t.deltaTime = t.timeStamp - a.timeStamp, t.angle = _(s, l), t.distance = D(s, l), P(i, t), t.offsetDirection = I(t.deltaX, t.deltaY), t.scale = o ? j(o.pointers, n) : 1, t.rotation = o ? N(o.pointers, n) : 0, A(i, t);
        var u = e.element;
    ...
    function P(e, t) {
        var i = t.center,
            ...
            r = e.prevDelta || {},
            a = e.prevInput || {};
        (t.eventType === Se || a.eventType === Oe) && (r = e.prevDelta = {
            x: a.deltaX || 0,
            y: a.deltaY || 0
        }, n = e.offsetDelta = {
            x: i.x,
    ...
    function A(e, t) {
        ...
        if (t.eventType != Ee && (l > ke || s.velocity === n)) {
            var u = s.deltaX - t.deltaX,
                c = s.deltaY - t.deltaY,
                f = V(l, u, c);
            r = f.x, a = f.y, i = de(f.x) > de(f.y) ? f.x : f.y, o = I(u, c), e.lastInterval = t
    ...
    function $(e) {
        for (var t = [], i = 0; i < e.pointers.length;) t[i] = {
            clientX: fe(e.pointers[i].clientX),
            clientY: fe(e.pointers[i].clientY)
        }, i++;
        return {
            timeStamp: pe(),
            pointers: t,
    ...
    function I(e, t) {
        return e === t ? Pe : de(e) >= de(t) ? e > 0 ? Ae : $e : t > 0 ? Me : Ve
    }
    ...
    function N(e, t) {
        return _(t[1], t[0], je) - _(e[1], e[0], je)
    }

    function j(e, t) {
        return D(t[0], t[1], je) / D(e[0], e[1], je)
    }

    function z() {
        this.evEl = qe, this.evWin = Fe, this.allow = !0, this.pressed = !1, S.apply(this, arguments)
    }
    ...
    function F() {
        this.evTarget = Be, this.evWin = Ye, this.started = !1, S.apply(this, arguments)
    }

    function L(e, t) {
        var i = b(e.touches),
            n = b(e.changedTouches);
        return t & (Oe | Ee) && (i = w(i.concat(n), "identifier", !0)), [i, n]
    }
    ...
    function W(e, t) {
        var i = b(e.touches),
            n = this.targetIds;
        if (t & (Se | Te) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
        ...
        for (r = 0; r < o.length;) n[o[r].identifier] && s.push(o[r]), t & (Oe | Ee) && delete n[o[r].identifier], r++;
    ...
    function R() {
        ...
        this.touch = new H(this.manager, e), this.mouse = new z(this.manager, e)
    }
    ...
    function B(e) {
        ...
        var t = m(e, it),
            i = m(e, nt);
        return t && i ? it + " " + nt : t || i ? t ? it : nt : m(e, et) ? et : Ke
    }

    function Y(e) {
        this.id = C(), this.manager = null, this.options = l(e || {}, this.defaults), this.options.enable = d(this.options.enable, !0), this.state = rt, this.simultaneous = {}, this.requireFail = []
    }
    ...
    function G(e) {
        return e == Ve ? "down" : e == Me ? "up" : e == Ae ? "left" : e == $e ? "right" : ""
    }
    ...
    function re(e, t) {
        return t = t || {}, t.recognizers = d(t.recognizers, re.defaults.preset), new ae(e, t)
    }

    function ae(e, t) {
        t = t || {}, this.options = l(t, re.defaults), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = e, this.input = T(this), this.touchAction = new Q(this, this.options.touchAction), oe(this, !0), o(t.recognizers, function (e) {
    ...
    u(z, S, {
        handler: function (e) {
            var t = ze[e.type];
            t & Se && 0 === e.button && (this.pressed = !0), t & Te && 1 !== e.which && (t = Oe), this.pressed && this.allow && (t & Oe && (this.pressed = !1), this.callback(this.manager, t, {
                pointers: [e],
                changedPointers: [e],
                pointerType: xe,
                srcEvent: e
    ...
    e.MSPointerEvent && (We = "MSPointerDown", Re = "MSPointerMove MSPointerUp MSPointerCancel"), u(q, S, {
        handler: function (e) {
            var t = this.store,
                i = !1,
            ...
            r & Se && (0 === e.button || o) ? 0 > s && (t.push(e), s = t.length - 1) : r & (Oe | Ee) && (i = !0), 0 > s || (t[s] = e, this.callback(this.manager, r, {
                pointers: t,
                changedPointers: [e],
                pointerType: a,
                srcEvent: e
    ...
    u(F, S, {
        handler: function (e) {
            ...
            if (t === Se && (this.started = !0), this.started) {
                var i = L.call(this, e, t);
                t & (Oe | Ee) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, t, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: be,
                    srcEvent: e
    ...
    u(H, S, {
        ...
        handler: function (e, t, i) {
            ...
            t & (Oe | Ee) && (this.mouse.allow = !0), this.callback(e, t, i)
        },
        destroy: function () {
    ...
    Q.prototype = {
        set: function (e) {
            e == Je && (e = this.compute()), Ze && (this.manager.element.style[Ue] = e), this.actions = e.toLowerCase().trim()
        },
        update: function () {
    ...
    Y.prototype = {
        ...
        recognizeWith: function (e) {
            ...
            return e = U(e, this), t[e.id] || (t[e.id] = e, e.recognizeWith(this)), this
        },
        dropRecognizeWith: function (e) {
            return a(e, "dropRecognizeWith", this) ? this : (e = U(e, this), delete this.simultaneous[e.id], this)
        },
        requireFailure: function (e) {
            if (a(e, "requireFailure", this)) return this;
            var t = this.requireFail;
            return e = U(e, this), -1 === y(t, e) && (t.push(e), e.requireFailure(this)), this
        },
        ...
        recognize: function (e) {
            var t = s({}, e);
            return f(this.options.enable, [this, t]) ? (this.state & (lt | ut | ct) && (this.state = rt), this.state = this.process(t), void(this.state & (at | ot | st | ut) && this.tryEmit(t))) : (this.reset(), void(this.state = ct))
        },
        process: function () {},
        ...
        process: function (e) {
            var t = this.state,
                ...
                n = t & (at | ot),
                r = this.attrTest(e);
            return n && (i & Ee || !r) ? t | ut : n || r ? i & Oe ? t | st : t & at ? t | ot : at : ct
        }
    }), u(J, Z, {
        defaults: {
            event: "pan",
        ...
        directionTest: function (e) {
            var t = this.options,
                ...
                a = e.deltaX,
                o = e.deltaY;
            return r & t.direction || (t.direction & Ie ? (r = 0 === a ? Pe : 0 > a ? Ae : $e, i = a != this.pX, n = Math.abs(e.deltaX)) : (r = 0 === o ? Pe : 0 > o ? Me : Ve, i = o != this.pY, n = Math.abs(e.deltaY))), e.direction = r, i && n > t.threshold && r & t.direction
        },
        attrTest: function (e) {
        ...
        process: function (e) {
            ...
            if (this._input = e, !n || !i || e.eventType & (Oe | Ee) && !a) this.reset();
            else if (e.eventType & Se) this.reset(), this._timer = r(function () {
                this.state = lt, this.tryEmit()
            }, t.time, this);
            else if (e.eventType & Oe) return lt;
            return ct
        },
        reset: function () {
        ...
        emit: function (e) {
            this.state === lt && (e && e.eventType & Oe ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = pe(), this.manager.emit(this.options.event, this._input)))
        }
    }), u(te, Z, {
        defaults: {
            event: "rotate",
        ...
        attrTest: function (e) {
            ...
            return i & (Ie | De) ? t = e.velocity : i & Ie ? t = e.velocityX : i & De && (t = e.velocityY), this._super.attrTest.call(this, e) && i & e.direction && e.distance > this.options.threshold && de(t) > this.options.velocity && e.eventType & Oe
        },
        emit: function (e) {
            var t = G(e.direction);
    ...
    ae.prototype = {
        ...
        recognize: function (e) {
            ...
            if (!t.stopped) {
                ...
                for (var a = 0; a < n.length;) i = n[a], t.stopped === dt || r && i != r && !i.canRecognizeWith(r) ? i.reset() : i.recognize(e), !r && i.state & (at | ot | st) && (r = t.curRecognizer = i), a++
            }
        },
        get: function (e) {
...
function () {
    function r(e) {
        e.addEventListener("click", function () {
            ...
            e.contains("flipped") === !0 ? e.remove("flipped") : e.add("flipped")
        })
    }
    for (var e = document.querySelectorAll(".card1.effect__click"), t = 0, i = e.length; i > t; t++) {
        var n = e[t];
        r(n)
    }
}(),
    ...
    function (e) {
        e(["jquery"], function (e) {
            return function () {
                ...
                function l(i, n) {
                    return i || (i = x()), t = e("#" + i.containerId), t.length ? t : (n && (t = g(i)), t)
                }
                ...
                function w(i) {
                    ...
                    function y() {
                        u.hover(V, M), !r.onclick && r.tapToDismiss && u.click($), r.closeButton && p && p.click(function (e) {
                            e.stopPropagation ? e.stopPropagation() : void 0 !== e.cancelBubble && e.cancelBubble !== !0 && (e.cancelBubble = !0), $(!0)
                    ...
                    function w() {
                        u.hide(), u[r.showMethod]({
                            ...
                            easing: r.showEasing,
                            complete: r.onShown
                        }), r.timeOut > 0 && (s = setTimeout($, r.timeOut), h.maxHideTime = parseFloat(r.timeOut), h.hideEta = (new Date).getTime() + h.maxHideTime, r.progressBar && (h.intervalId = setInterval(I, 10)))
                    }
                    ...
                    function E() {
                        r.closeButton && (p.addClass("toast-close-button").attr("role", "button"), u.prepend(p))
                    }

                    function P() {
                        r.progressBar && (d.addClass("toast-progress"), u.prepend(d))
                    }
                    ...
                    function $(t) {
                        ...
                        return !e(":focus", u).length || t ? (clearTimeout(h.intervalId), u[i]({
                            duration: n,
                            easing: a,
                            complete: function () {
                                C(u), r.onHidden && "hidden" !== v.state && r.onHidden(), v.state = "hidden", v.endTime = new Date, b(v)
                            }
                        })) : void 0
                    }

                    function M() {
                        (r.timeOut > 0 || r.extendedTimeOut > 0) && (s = setTimeout($, r.extendedTimeOut), h.maxHideTime = parseFloat(r.extendedTimeOut), h.hideEta = (new Date).getTime() + h.maxHideTime)
                    }

                    function V() {
                        clearTimeout(s), h.hideEta = 0, u.stop(!0, !0)[r.showMethod]({
                            duration: r.showDuration,
                            easing: r.showEasing
                        })
                    }
                    ...
                    if ("undefined" != typeof i.optionsOverride && (r = e.extend(r, i.optionsOverride), a = i.optionsOverride.iconClass || a), !A(r, i)) {
                        n++, t = l(r, !0);
                        var s = null,
                            u = e("<div/>"),
                            c = e("<div/>"),
                        ...
                        return g(), w(), y(), b(v), r.debug && console && console.log(v), u
                    }
                }
        ...
        var t = {
            init: function (t) {
                ...
                t = e.extend(i, t), e(this).each(function () {
                    function r(i) {
                        a = !1, o = !1, e("body").css("overflow", ""), e("#sidenav-overlay").velocity({
                            opacity: 0
                        }, {
                            duration: 200,
                            queue: !1,
                    ...
                    240 != t.menuWidth && n.css("width", t.menuWidth), e("body").append(e('<div class="drag-target"></div>')), "left" == t.edge ? (n.css("left", -1 * (t.menuWidth + 10)), e(".drag-target").css({
                        left: 0
                    })) : (n.addClass("right-aligned").css("right", -1 * (t.menuWidth + 10)).css("left", ""), e(".drag-target").css({
                        right: 0
                    })), n.hasClass("fixed") && window.innerWidth > 992 && n.css("left", 0), n.hasClass("fixed") && e(window).resize(function () {
                        window.innerWidth > 992 ? 0 !== e("#sidenav-overlay").css("opacity") && o ? r(!0) : (n.removeAttr("style"), n.css("width", t.menuWidth)) : o === !1 && ("left" === t.edge ? n.css("left", -1 * (t.menuWidth + 10)) : n.css("right", -1 * (t.menuWidth + 10)))
                    }), t.closeOnClick === !0 && n.on("click.itemclick", "a:not(.collapsible-header)", function () {
                        r()
                    });
                    var a = !1,
                        o = !1;
                    e(".drag-target").on("click", function () {
                        r()
                    }), e(".drag-target").hammer({
                        prevent_default: !1
                    }).bind("pan", function (i) {
                        if ("touch" == i.gesture.pointerType) {
                            var s = (i.gesture.direction, i.gesture.center.x);
                            i.gesture.center.y, i.gesture.velocityX;
                            if (e("body").css("overflow", "hidden"), 0 === e("#sidenav-overlay").length) {
                                var c = e('<div id="sidenav-overlay"></div>');
                                c.css("opacity", 0).click(function () {
                                    r()
                                }), e("body").append(c)
                            }
                            if ("left" === t.edge && (s > t.menuWidth ? s = t.menuWidth : 0 > s && (s = 0)), "left" === t.edge) s < t.menuWidth / 2 ? o = !1 : s >= t.menuWidth / 2 && (o = !0), n.css("left", s - t.menuWidth);
                            else {
                                s < window.innerWidth - t.menuWidth / 2 ? o = !0 : s >= window.innerWidth - t.menuWidth / 2 && (o = !1);
                                var f = -1 * (s - t.menuWidth / 2);
                                f > 0 && (f = 0), n.css("right", f)
                            }
                            var d;
                            "left" === t.edge ? (d = s / t.menuWidth, e("#sidenav-overlay").velocity({
                                opacity: d
                            }, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (d = Math.abs((s - window.innerWidth) / t.menuWidth), e("#sidenav-overlay").velocity({
                                opacity: d
                            }, {
                                duration: 50,
                                queue: !1,
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            var r = i.gesture.velocityX;
                            a = !1, "left" === t.edge ? o && .3 >= r || -.5 > r ? (n.velocity({
                                left: 0
                            }, {
                                duration: 300,
                                queue: !1,
                                ...
                                right: 0,
                                left: ""
                            })) : (!o || r > .3) && (e("body").css("overflow", ""), n.velocity({
                                left: -1 * (t.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
                                ...
                                right: "",
                                left: 0
                            })) : (!o || -.3 > r) && (e("body").css("overflow", ""), n.velocity({
                                right: -1 * (t.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
                        ...
                        if (o === !0) o = !1, a = !1, r();
                            ...
                            e("body").css("overflow", "hidden"), "left" === t.edge ? (e(".drag-target").css({
                                width: "50%",
                                right: 0,
                                left: ""
                            }), n.velocity({
            ...
            return this.each(function () {
                ...
                if (!e(this).hasClass("initialized")) {
                    ...
                    var t = !1,
                        ...
                        r = 200,
                        a = e(this),
                        o = e("<div></div>").addClass("material-placeholder");
                    a.wrap(o), a.on("click", function () {
                        var r = a.parent(".material-placeholder"),
                            o = window.innerWidth,
                        ...
                        if (i === !1) return u(), !1;
                        if (t && i === !0) return u(), !1;
                        i = !1, a.addClass("active"), t = !0, r.css({
                        ...
                        if (e("body").append(f), f.velocity({
                            ...
                            var d = e('<div class="materialbox-caption"></div>');
                            d.text(a.data("caption")), e("body").append(d), d.css({
                                display: "inline"
                            }), d.velocity({
                                opacity: 1
                            }, {
                        ...
                        var p = 0,
                            ...
                            m = 0,
                            g = 0;
                        h > v ? (p = c / l, m = .9 * o, g = .9 * o * p) : (p = l / c, m = .9 * s * p, g = .9 * s), a.hasClass("responsive-img") ? a.velocity({
                            "max-width": m,
                            width: l
                        }, {
                            duration: 0,
                            ...
                            complete: function () {
                                a.css({
                                    ...
                                    height: g,
                                    width: m,
                                    left: e(document).scrollLeft() + o / 2 - a.parent(".material-placeholder").offset().left - m / 2,
                                    top: e(document).scrollTop() + s / 2 - a.parent(".material-placeholder").offset().top - g / 2
                                }, {
                                    duration: n,
                                    queue: !1,
                                    easing: "easeOutQuad",
...
$(selector).on("click", function () {
    ...
    function (e) {
        ...
        function r(t, l, u, f) {
            function b() {
                return r._.node("div", r._.node("div", r._.node("div", r._.node("div", y.component.nodes(p.open), v.box), v.wrap), v.frame), v.holder)
            }

            function w() {
                m.data(l, y).addClass(v.input).attr("tabindex", -1).val(m.data("value") ? y.get("select", h.format) : t.value), h.editable || m.on("focus." + p.id + " click." + p.id, function (e) {
                    e.preventDefault(), y.$root[0].focus()
                }).on("keydown." + p.id, k), s(t, {
                    haspopup: !0,
                    expanded: !1,
                    readonly: !1,
                    owns: t.id + "_root"
            ...
            function x() {
                y.$root.on({
                    ...
                    "mousedown click": function (t) {
                        var i = t.target;
                        i != y.$root.children()[0] && (t.stopPropagation(), "mousedown" != t.type || e(i).is("input, select, textarea, button, option") || (t.preventDefault(), y.$root[0].focus()))
                    }
                }).on({
                    focus: function () {
                        m.addClass(v.target)
                    ...
                    var t = e(this),
                        ...
                        r = c();
                    r = r && (r.type || r.href), (n || r && !e.contains(y.$root[0], r)) && y.$root[0].focus(), !n && i.nav ? y.set("highlight", y.component.item.highlight, {
                        nav: i.nav
            ...
            function C() {
                var i;
                h.hiddenName === !0 ? (i = t.name, t.name = "") : (i = ["string" == typeof h.hiddenPrefix ? h.hiddenPrefix : "", "string" == typeof h.hiddenSuffix ? h.hiddenSuffix : "_submit"], i = i[0] + t.name + i[1]), y._hidden = e('<input type=hidden name="' + i + '"' + (m.data("value") || t.value ? ' value="' + y.get("select", h.formatSubmit) + '"' : "") + ">")[0], m.on("change." + p.id, function () {
                    y._hidden.value = t.value ? y.get("select", h.formatSubmit) : ""
                }), h.container ? e(h.container).append(y._hidden) : m.after(y._hidden)
            }

            function k(e) {
                var t = e.keyCode,
                    i = /^(8|46)$/.test(t);
                return 27 == t ? (y.close(), !1) : void((32 == t || i || !p.open && y.component.key[t]) && (e.preventDefault(), e.stopPropagation(), i ? y.clear().close() : y.open()))
            }
            ...
            var d = !1,
                ...
                h = u ? e.extend(!0, {}, u.defaults, f) : f || {},
                v = e.extend({}, r.klasses(), h.klass),
                m = e(t),
                g = function () {
                    return this.start()
                },
                y = g.prototype = {
                    ...
                    $node: m,
                    start: function () {
                        return p && p.start ? y : (p.methods = {}, p.start = !0, p.open = !1, p.type = t.type, t.autofocus = t == c(), t.readOnly = !h.editable, t.id = t.id || p.id, "text" != t.type && (t.type = "text"), y.component = new u(y, h), y.$root = e(r._.node("div", b(), v.picker, 'id="' + t.id + '_root" tabindex="0"')), x(), h.formatSubmit && C(), w(), h.container ? e(h.container).append(y.$root) : m.after(y.$root), y.on({
                            ...
                            close: h.onClose,
                            set: h.onSet
                        }), d = a(y.$root.children()[0]), t.autofocus && y.open(), y.trigger("start").trigger("render"))
                    },
                    render: function (e) {
                        return e ? y.$root.html(b()) : y.$root.find("." + v.box).html(y.component.nodes(p.open)), y.trigger("render")
                    },
                    stop: function () {
                        return p.start ? (y.close(), y._hidden && y._hidden.parentNode.removeChild(y._hidden), y.$root.remove(), m.removeClass(v.input).removeData(l), setTimeout(function () {
                            m.off("." + p.id)
                        }, 0), t.type = p.type, t.readOnly = !1, y.trigger("stop"), p.methods = {}, p.start = !1, y) : y
                    },
                    open: function (a) {
                        return p.open ? y : (m.addClass(v.active), s(t, "expanded", !0), setTimeout(function () {
                            y.$root.addClass(v.opened), s(y.$root[0], "hidden", !1)
                        }, 0), a !== !1 && (p.open = !0, d && n.css("overflow", "hidden").css("padding-right", "+=" + o()), y.$root[0].focus(), i.on("click." + p.id + " focusin." + p.id, function (e) {
                            var i = e.target;
                            ...
                            var i = t.keyCode,
                                n = y.component.key[i],
                                a = t.target;
                            27 == i ? y.close(!0) : a != y.$root[0] || !n && 13 != i ? e.contains(y.$root[0], a) && 13 == i && (t.preventDefault(), a.click()) : (t.preventDefault(), n ? r._.trigger(y.component.key.go, y, [r._.trigger(n)]) : y.$root.find("." + v.highlighted).hasClass(v.disabled) || y.set("select", y.component.item.highlight).close())
                        })), y.trigger("open"))
                    },
                    close: function (e) {
                        return e && (y.$root.off("focus.toOpen")[0].focus(), setTimeout(function () {
                        ...
                        }, 0), p.open ? (p.open = !1, d && n.css("overflow", "").css("padding-right", "-=" + o()), i.off("." + p.id), y.trigger("close")) : y
                    },
                    clear: function (e) {
                    ...
                    set: function (t, i, n) {
                        ...
                        if (n = o && e.isPlainObject(i) ? i : n || {}, t) {
                            o || (s[t] = i);
                            for (r in s) a = s[r], r in y.component.item && (void 0 === a && (a = null), y.component.set(r, a, n)), ("select" == r || "clear" == r) && m.val("clear" == r ? "" : y.get(r, h.format)).trigger("change");
                            y.render()
                        }
        ...
        return r.klasses = function (e) {
            ...
            e.fn[t] = function (n, a) {
                var o = this.data(t);
                return "picker" == n ? o : o && "string" == typeof n ? r._.trigger(o[n], o, [a]) : this.each(function () {
                    var a = e(this);
                    a.data(t) || new r(this, t, i, n)
                })
    ...
    function (e) {
        ...
        a.prototype.set = function (e, t, i) {
            ...
            var u, c, p, h, a = this,
                ...
                f = a.item.min,
                d = a.item.max,
                v = l && a.item.disable.filter(function (e) {
                    if (t.isArray(e)) {
            ...
            if ((!n || !n.nav) && (!l && a.disabled(i) || l && a.disabled(i) && (v || u || c) || !l && (i.pick <= f.pick || i.pick >= d.pick)))
                for (l && !v && (!c && s > 0 || !u && 0 > s) && (s *= -1); a.disabled(i) && (Math.abs(s) > 1 && (i.month < o.month || i.month > o.month) && (i = o, s = s > 0 ? 1 : -1), i.pick <= f.pick ? (p = !0, s = 1, i = a.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : -1)])) : i.pick >= d.pick && (h = !0, s = -1, i = a.create([d.year, d.month, d.date + (i.pick === d.pick ? 0 : 1)])), !p || !h);) i = a.create([i.year, i.month, i.date + s]);
            return i
            ...
            var t = this,
                ...
                v = function (e) {
                    return r.node("div", " ", a.klass["nav" + (e ? "Next" : "Prev")] + (e && c.year >= p.year && c.month >= p.month || !e && c.year <= d.year && c.month <= d.month ? " " + a.klass.navDisabled : ""), "data-nav=" + (e || -1) + " " + r.ariaAttr({
                        role: "button",
                ...
                m = function (i) {
                    ...
                    return "short_months" == i && (n = a.monthsShort), a.selectMonths && void 0 == i ? r.node("select", r.group({
                        min: 0,
                        max: 11,
                        i: 1,
                        node: "option",
                        item: function (e) {
                            return [n[e], 0, "value=" + e + (c.month == e ? " selected" : "") + (c.year == d.year && e < d.month || c.year == p.year && e > p.month ? " disabled" : "")]
                        }
                    }), a.klass.selectMonth + " browser-default", (e ? "" : "disabled") + " " + r.ariaAttr({
                        controls: t.$node[0].id + "_table"
                    }) + ' title="' + a.labelMonthSelect + '"') : "short_months" == i ? null != l ? r.node("div", n[l.month]) : r.node("div", n[c.month]) : r.node("div", n[c.month], a.klass.month)
                },
                g = function (i) {
                    var n = c.year,
                    ...
                    if (o) {
                        var s = d.year,
                            ...
                            u = n - o,
                            f = n + o;
                        if (s > u && (f += s - u, u = s), f > l) {
                            var h = u - s,
                                v = f - l;
                            u -= h > v ? v : h, f = l
                        }
                        if (a.selectYears && void 0 == i) return r.node("select", r.group({
                            min: u,
                            max: f,
                            i: 1,
                            node: "option",
                    ...
                    return "raw" == i ? r.node("div", n) : r.node("div", n, a.klass.year)
                };
            return createDayLabel = function () {
                ...
                var t = a.weekdaysFull[e];
                return t
            }, r.node("div", r.node("div", createWeekdayLabel(), "picker__weekday-display") + r.node("div", m("short_months"), a.klass.month_display) + r.node("div", createDayLabel(), a.klass.day_display) + r.node("div", g("raw"), a.klass.year_display), a.klass.date_display) + r.node("div", r.node("div", (a.selectYears ? m() + g() : m() + g()) + v() + v(1), a.klass.header) + r.node("table", h + r.node("tbody", r.group({
                min: 0,
                max: n - 1,
                i: 1,
                node: "tr",
                    ...
                    return [r.group({
                        ...
                        item: function (e) {
                            ...
                            var i = l && l.pick == e.pick,
                                n = u && u.pick == e.pick,
                                o = f && t.disabled(e) || e.pick < d.pick || e.pick > p.pick,
                                h = r.trigger(t.formats.toString, t, [a.format, e]);
                ...
                readonly: !0
            })), a.klass.calendar_container) + r.node("div", r.node("button", a.today, "btn-flat picker__today", "type=button data-pick=" + s.pick + (e && !t.disabled(s) ? "" : " disabled") + " " + r.ariaAttr({
                controls: t.$node[0].id
            })) + r.node("button", a.clear, "btn-flat picker__clear", "type=button data-clear=1" + (e ? "" : " disabled") + " " + r.ariaAttr({
                controls: t.$node[0].id
            })) + r.node("button", a.close, "btn-flat picker__close", "type=button data-close=true " + (e ? "" : " disabled") + " " + r.ariaAttr({
                controls: t.$node[0].id
            })), a.klass.footer)
    ...
    function (e) {
        e.fn.scrollTo = function (t) {
            ...
            this.each(function () {
                function o() {
                    void 0 !== n.data("induration") && (r.inDuration = n.data("inDuration")), void 0 !== n.data("outduration") && (r.outDuration = n.data("outDuration")), void 0 !== n.data("constrainwidth") && (r.constrain_width = n.data("constrainwidth")), void 0 !== n.data("hover") && (r.hover = n.data("hover")), void 0 !== n.data("gutter") && (r.gutter = n.data("gutter")), void 0 !== n.data("beloworigin") && (r.belowOrigin = n.data("beloworigin"))
                }

                function s() {
                    o(), a.addClass("active"), r.constrain_width === !0 && a.css("width", n.outerWidth());
                    var t = 0;
                    r.belowOrigin === !0 && (t = n.height());
                    var i = n.offset().left,
                        s = 0,
                        l = r.gutter;
                    i + a.innerWidth() > e(window).width() && (s = n.innerWidth() - a.innerWidth(), l = -1 * l), a.css({
                        position: "absolute",
                        top: n.position().top + t,
                        left: n.position().left + s + l
                ...
                if (o(), n.after(a), r.hover) {
                    var u = !1;
                    n.unbind("click." + n.attr("id")), n.on("mouseenter", function (e) {
                        u === !1 && (s(), u = !0)
                    }), n.on("mouseleave", function (t) {
                        var i = t.toElement || t.relatedTarget;
                        e(i).closest(".dropdown-content").is(a) || (a.stop(!0, !0), l(), u = !1)
                    }), a.on("mouseleave", function (t) {
                        var i = t.toElement || t.relatedTarget;
                        e(i).closest(".dropdown-button").is(n) || (a.stop(!0, !0), l(), u = !1)
                    })
                } else n.unbind("click." + n.attr("id")), n.bind("click." + n.attr("id"), function (t) {
                    n[0] == t.currentTarget && 0 === e(t.target).closest(".dropdown-content").length ? (t.preventDefault(), s()) : n.hasClass("active") && (l(), e(document).unbind("click." + a.attr("id"))), a.hasClass("active") && e(document).bind("click." + a.attr("id"), function (t) {
                        !a.is(t.target) && !n.is(t.target) && !n.find(t.target).length > 0 && (l(), e(document).unbind("click." + a.attr("id")))
                    })
                });
                n.on("open", s), n.on("close", l)
            })
        }, e(document).ready(function () {
...
Vel = $ ? $.Velocity : Velocity,
        ...
        e(document).ready(function () {
            ...
            Materialize.updateTextFields = function () {
                ...
                e(t).each(function (t, i) {
                    e(i).val().length > 0 || void 0 !== e(this).attr("placeholder") || e(i)[0].validity.badInput === !0 ? e(this).siblings("label, i").addClass("active") : e(this).siblings("label, i").removeClass("active")
                })
            };
            var t = "input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";
            e("input[autofocus]").siblings("label, i").addClass("active"), e(document).on("change", t, function () {
                ...
                var t = e(this);
                0 === t.val().length && t[0].validity.badInput !== !0 && void 0 === t.attr("placeholder") && t.siblings("label, i").removeClass("active"), validate_field(t)
            ...
            e(n).each(function () {
                var t = e(this);
                t.val().length && r(t)
            }), e("body").on("keyup keydown", n, function () {
                r(e(this))
            }), e(".file-field").each(function () {
                var t = e(this).find("input.file-path");
                e(this).find('input[type="file"]').change(function () {
                    t.val(e(this)[0].files[0].name), t.trigger("change")
                })
            });
            ...
            e(document).on("change", a, function (t) {
                ...
                var i = e(this).siblings(".thumb");
                i.length <= 0 && (i = e('<span class="thumb"><span class="value"></span></span>'), e(this).append(i)), i.find(".value").html(e(this).val()), o = !0, e(this).addClass("active"), i.hasClass("active") || i.velocity({
                    height: "30px",
                    width: "30px",
                    top: "-20px",
                    marginLeft: "-15px"
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), s = void 0 === t.pageX || null === t.pageX ? t.originalEvent.touches[0].pageX - e(this).offset().left : t.pageX - e(this).offset().left;
                var n = e(this).outerWidth();
                0 > s ? s = 0 : s > n && (s = n), i.addClass("active").css("left", s), i.find(".value").html(e(this).val())
            ...
            e(this).each(function () {
                if ($select = e(this), !$select.hasClass("browser-default")) {
                    ...
                    if (i && ($select.parent().find("i").remove(), $select.parent().find("input").remove(), $select.unwrap(), e("ul#select-options-" + i).remove()), "destroy" === t) return void $select.data("select-id", null).removeClass("initialized");
                    var n = Materialize.guid();
                    $select.data("select-id", n);
                    var r = e('<div class="select-wrapper"></div>');
                    r.addClass($select.attr("class"));
                    var s, a = e('<ul id="select-options-' + n + '" class="dropdown-content select-dropdown"></ul>'),
                        o = $select.children("option");
                    s = void 0 !== $select.find("option:selected") ? $select.find("option:selected") : a.first(), o.each(function () {
                        a.append(e('<li class="' + (e(this).is(":disabled") ? "disabled" : "") + '"><span>' + e(this).html() + "</span></li>"))
                    }), a.find("li").each(function (i) {
                        var n = $select;
                        e(this).click(function () {
                            e(this).hasClass("disabled") || (n.find("option").eq(i).prop("selected", !0), n.trigger("change"), n.siblings("input.select-dropdown").val(e(this).text()), "undefined" != typeof t && t())
                        })
                    }), $select.wrap(r);
                    var l = e('<span class="caret">&#9660;</span>');
                    $select.is(":disabled") && l.addClass("disabled");
                    var u = e('<input type="text" class="select-dropdown" readonly="true" ' + ($select.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + n + '" value="' + s.html() + '"/>');
                    $select.before(u), u.before(l), e("body").append(a), $select.is(":disabled") || u.dropdown({
                        hover: !1
                    }), $select.attr("tabindex") && e(u[0]).attr("tabindex", $select.attr("tabindex")), $select.addClass("initialized"), u.on("focus", function () {
                        e(this).trigger("open"), s = e(this).val(), selectedOption = a.find("li").filter(function () {
                        ...
                        t.find("li.active").removeClass("active"), e(i).addClass("active"), t.scrollTo(i)
                    }, filterQuery = [], onKeyDown = function (t) {
                        if (9 == t.which) return void u.trigger("close");
                        if (40 == t.which && !a.is(":visible")) return void u.trigger("open");
                        if (13 != t.which || a.is(":visible")) {
                            t.preventDefault(), letter = String.fromCharCode(t.which).toLowerCase();
                            var i = [9, 13, 27, 38, 40];
                            letter && -1 === i.indexOf(t.which) && (filterQuery.push(letter), string = filterQuery.join(""), newOption = a.find("li").filter(function () {
    ...
    function (e) {
        ...
        return function (e, t, i, n) {
            ...
            function l(e, i, n, r) {
                ...
                function p(t) {
                    for (var i = 0, r = 1, a = b - 1; r != a && k[r] <= t; ++r) i += w;
                    --r;
                    var o = (t - k[r]) / (k[r + 1] - k[r]),
                        s = i + o * w,
                        l = u(s, e, n);
                    return l >= m ? c(t, s) : 0 == l ? s : d(t, i, i + w)
                }
                ...
                var k = x ? new Float32Array(b) : new Array(b),
                    S = !1,
                    T = function (t) {
                        return S || h(), e === i && n === r ? t : 0 === t ? 0 : 1 === t ? 1 : l(p(t), i, r)
                    };
            ...
            function u(e, t) {
                var i = e;
                return h.isString(e) ? b.Easings[e] || (i = !1) : i = h.isArray(e) && 1 === e.length ? s.apply(null, e) : h.isArray(e) && 2 === e.length ? w.apply(null, e.concat([t])) : h.isArray(e) && 4 === e.length ? l.apply(null, e) : !1, i === !1 && (i = b.Easings[b.defaults.easing] ? b.defaults.easing : y), i
            }
                ...
                if (e) {
                    ...
                    for (var a = 0; i > a; a++)
                        if (b.State.calls[a]) {
                            ...
                            for (var g = Math.min((t - d) / u.duration, 1), y = 0, w = l.length; w > y; y++) {
                                var C = l[y],
                                    S = C.element;
                                if (o(S)) {
                                    var T = !1;
                                    ...
                                    for (var E in C)
                                        if ("element" !== E) {
                                            var A, P = C[E],
                                                $ = h.isString(P.easing) ? b.Easings[P.easing] : P.easing;
                                            if (1 === g) A = P.endValue;
                                            else {
                                                var M = P.endValue - P.startValue;
                                                if (A = P.startValue + M * $(g, u, M), !p && A === P.currentValue) continue
                                            }
                                            if (P.currentValue = A, "tween" === E) m = A;
                                            else {
                                                if (x.Hooks.registered[E]) {
                                                    var V = x.Hooks.getRoot(E),
                                                        I = o(S).rootPropertyValueCache[V];
                                                    I && (P.rootPropertyValue = I)
                                                }
                                                var D = x.setPropertyValue(S, E, P.currentValue + (0 === parseFloat(A) ? "" : P.unitType), P.rootPropertyValue, P.scrollData);
                                                x.Hooks.registered[E] && (o(S).rootPropertyValueCache[V] = x.Normalizations.registered[V] ? x.Normalizations.registered[V]("extract", null, D[1]) : D[1]), "transform" === D[0] && (T = !0)
                                            }
                                        }
                                    u.mobileHA && o(S).transformCache.translate3d === n && (o(S).transformCache.translate3d = "(0px, 0px, 0px)", T = !0), T && x.flushTransformCache(S)
                                }
                            }
                            u.display !== n && "none" !== u.display && (b.State.calls[a][2].display = !1), u.visibility !== n && "hidden" !== u.visibility && (b.State.calls[a][2].visibility = !1), u.progress && u.progress.call(s[1], s[1], g, Math.max(0, d + u.duration - t), d, m), 1 === g && f(a)
                        }
                }
            ...
            function f(e, t) {
                ...
                for (var i = b.State.calls[e][0], r = b.State.calls[e][1], a = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, u = 0, c = i.length; c > u; u++) {
                    var f = i[u].element;
                    if (t || a.loop || ("none" === a.display && x.setPropertyValue(f, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(f, "visibility", a.visibility)), a.loop !== !0 && (v.queue(f)[1] === n || !/\.velocityQueueEntryFlag/i.test(v.queue(f)[1])) && o(f)) {
                    ...
                    s && a.loop !== !0 && s(r), o(f) && a.loop === !0 && !t && (v.each(o(f).tweensContainer, function (e, t) {
                        /^rotate/.test(e) && 360 === parseFloat(t.endValue) && (t.endValue = 0, t.startValue = 360), /^backgroundPosition/.test(e) && 100 === parseFloat(t.endValue) && "%" === t.unitType && (t.endValue = 0, t.startValue = 100)
                    }), b(f, "reverse", {
                        loop: !0,
                        delay: a.delay
                    })), a.queue !== !1 && v.dequeue(f, a.queue)
                }
                b.State.calls[e] = !1;
            ...
            var v, d = function () {
                ...
                m = !1;
            if (e.fn && e.fn.jquery ? (v = e, m = !0) : v = t.Velocity.Utilities, 8 >= d && !m) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            ...
            var w = function () {
                ...
                return function n(e, t, r) {
                    var c, f, d, a = {
                        ...
                        l = 1e-4,
                        u = .016;
                    for (e = parseFloat(e) || 500, t = parseFloat(t) || 20, r = r || null, a.tension = e, a.friction = t, c = null !== r, c ? (s = n(e, t), f = s / r * u) : f = u; d = i(d || a, f), o.push(1 + d.x), s += 16, Math.abs(d.x) > l && Math.abs(d.v) > l;);
                    return c ? function (e) {
            ...
            var x = b.CSS = {
                ...
                Hooks: {
                    ...
                    injectValue: function (e, t, i) {
                        ...
                        if (n) {
                            var o, s, r = n[0],
                                a = n[1];
                            return i = x.Hooks.cleanRootPropertyValue(r, i), o = i.toString().match(x.RegEx.valueSplit), o[a] = t, s = o.join(" ")
                        }
                        return i
                    }
                },
                    ...
                    prefixCheck: function (e) {
                        ...
                        for (var t = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = t.length; n > i; i++) {
                            ...
                            if (r = 0 === i ? e : t[i] + e.replace(/^\w/, function (e) {
                                ...
                                }), h.isString(b.State.prefixElement.style[r])) return b.State.prefixMatches[e] = r, [r, !0]
                        }
                        return [e, !1]
                    }
                },
                Values: {
                    hexToRgb: function (e) {
                        var n, t = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
                            i = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
                        return e = e.replace(t, function (e, t, i, n) {
                            return t + t + i + i + n + n
                        }), n = i.exec(e), n ? [parseInt(n[1], 16), parseInt(n[2], 16), parseInt(n[3], 16)] : [0, 0, 0]
                    },
                ...
                getPropertyValue: function (e, i, r, a) {
                    function s(e, i) {
                        ...
                        if ("auto" === l && /^(top|right|bottom|left)$/i.test(i)) {
                            var h = s(e, "position");
                            ("fixed" === h || "absolute" === h && /top|left/i.test(i)) && (l = v(e).position()[i] + "px")
                        }
                        return l
                    }
                    var l;
            ...
            var C = function () {
                ...
                function r() {
                    function e(e) {
                        function f(e, t) {
                            var i = n,
                                o = n,
                                s = n;
                            return h.isArray(e) ? (i = e[0], !h.isArray(e[1]) && /^[\d-]/.test(e[1]) || h.isFunction(e[1]) || x.RegEx.isHex.test(e[1]) ? s = e[1] : (h.isString(e[1]) && !x.RegEx.isHex.test(e[1]) || h.isArray(e[1])) && (o = t ? e[1] : u(e[1], a.duration), e[2] !== n && (s = e[2]))) : i = e, t || (o = o || a.easing), h.isFunction(i) && (i = i.call(r, S, k)), h.isFunction(s) && (s = s.call(r, S, k)), [i || 0, o, s]
                        }
                        ...
                        function p() {
                            ...
                            var s = 100,
                                l = {};
                            if (a && n) l.emToPx = D.lastEmToPx, l.percentToPxWidth = D.lastPercentToPxWidth, l.percentToPxHeight = D.lastPercentToPxHeight;
                            else {
                                var u = o(r).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                b.init(u), e.myParent.appendChild(u), v.each(["overflow", "overflowX", "overflowY"], function (e, t) {
                                    b.CSS.setPropertyValue(u, t, "hidden")
                                }), b.CSS.setPropertyValue(u, "position", e.position), b.CSS.setPropertyValue(u, "fontSize", e.fontSize), b.CSS.setPropertyValue(u, "boxSizing", "content-box"), v.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (e, t) {
                            ...
                            return null === D.remToPx && (D.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === D.vwToPx && (D.vwToPx = parseFloat(t.innerWidth) / 100, D.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = D.remToPx, l.vwToPx = D.vwToPx, l.vhToPx = D.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                        }
                        if (a.begin && 0 === S) try {
                            a.begin.call(m, m)
                        } catch (g) {
                        ...
                        if ("scroll" === P) {
                            var O, A, $, C = /^x$/i.test(a.axis) ? "Left" : "Top",
                                T = parseFloat(a.offset) || 0;
                            a.container ? h.isWrapped(a.container) || h.isNode(a.container) ? (a.container = a.container[0] || a.container, O = a.container["scroll" + C], $ = O + v(r).position()[C.toLowerCase()] + T) : a.container = null : (O = b.State.scrollAnchor[b.State["scrollProperty" + C]], A = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === C ? "Top" : "Left")]], $ = v(r).offset()[C.toLowerCase()] + T), s = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: O,
                                    currentValue: O,
                                ...
                                element: r
                            }, b.debug && console.log("tweensContainer (scroll): ", s.scroll, r)
                        } else if ("reverse" === P) {
                            if (!o(r).tweensContainer) return void v.dequeue(r, a.queue);
                            "none" === o(r).opts.display && (o(r).opts.display = "auto"), "hidden" === o(r).opts.visibility && (o(r).opts.visibility = "visible"), o(r).opts.loop = !1, o(r).opts.begin = null, o(r).opts.complete = null, w.easing || delete a.easing, w.duration || delete a.duration, a = v.extend({}, o(r).opts, a);
                            var M = v.extend(!0, {}, o(r).tweensContainer);
                            for (var V in M)
                                if ("element" !== V) {
                                    var I = M[V].startValue;
                                    M[V].startValue = M[V].currentValue = M[V].endValue, M[V].endValue = I, h.isEmptyObject(w) || (M[V].easing = a.easing), b.debug && console.log("reverse tweensContainer (" + V + "): " + JSON.stringify(M[V]), r)
                                }
                            s = M
                        } else if ("start" === P) {
                            var M;
                            o(r).tweensContainer && o(r).isAnimating === !0 && (M = o(r).tweensContainer), v.each(y, function (e, t) {
                                if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(e)) {
                                    ...
                                    if (x.RegEx.isHex.test(r)) {
                                        for (var s = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(r), u = o ? x.Values.hexToRgb(o) : n, c = 0; c < s.length; c++) {
                                            var d = [l[c]];
                                            a && d.push(a), u !== n && d.push(u[c]), y[e + s[c]] = d
                                        }
                                        delete y[e]
                                    }
                                }
                            ...
                            for (var N in y) {
                                ...
                                var L = x.Hooks.getRoot(N),
                                    H = !1;
                                if (o(r).isSVG || "tween" === L || x.Names.prefixCheck(L)[1] !== !1 || x.Normalizations.registered[L] !== n) {
                                    (a.display !== n && null !== a.display && "none" !== a.display || a.visibility !== n && "hidden" !== a.visibility) && /opacity|filter/.test(N) && !F && 0 !== z && (F = 0), a._cacheValues && M && M[N] ? (F === n && (F = M[N].endValue + M[N].unitType), H = o(r).rootPropertyValueCache[L]) : x.Hooks.registered[N] ? F === n ? (H = x.getPropertyValue(r, L), F = x.getPropertyValue(r, N, H)) : H = x.Hooks.templates[L][1] : F === n && (F = x.getPropertyValue(r, N));
                                    var W, R, Q, B = !1;
                                    if (W = d(N, F), F = W[0], Q = W[1], W = d(N, z), z = W[0].replace(/^([+-\/*])=/, function (e, t) {
                                            return B = t, ""
                                        }), R = W[1], F = parseFloat(F) || 0, z = parseFloat(z) || 0, "%" === R && (/^(fontSize|lineHeight)$/.test(N) ? (z /= 100, R = "em") : /^scale/.test(N) ? (z /= 100, R = "") : /(Red|Green|Blue)$/i.test(N) && (z = z / 100 * 255, R = "")), /[\/*]/.test(B)) R = Q;
                                    else if (Q !== R && 0 !== F)
                                        if (0 === z) R = Q;
                                        else {
                                            l = l || p();
                                            ...
                                            switch (Q) {
                                            case "%":
                                                F *= "x" === Y ? l.percentToPxWidth : l.percentToPxHeight;
                                                break;
                                            case "px":
                                                break;
                                            default:
                                            ...
                                            switch (R) {
                                            case "%":
                                                F *= 1 / ("x" === Y ? l.percentToPxWidth : l.percentToPxHeight);
                                                break;
                                            case "px":
                                                break;
                                            default:
                                    ...
                                    s[N] = {
                                        ...
                                        unitType: R,
                                        easing: q
                                    }, b.debug && console.log("tweensContainer (" + N + "): " + JSON.stringify(s[N]), r)
                                } else b.debug && console.log("Skipping [" + L + "] due to a lack of browser support.")
                            }
                            s.element = r
                        }
                        s.element && (x.Values.addClass(r, "velocity-animating"), _.push(s), "" === a.queue && (o(r).tweensContainer = s, o(r).opts = a), o(r).isAnimating = !0, S === k - 1 ? (b.State.calls.push([_, m, a, null, E.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : S++)
                    }
                    var l, r = this,
                        a = v.extend({}, b.defaults, w),
                        s = {};
                    switch (o(r) === n && b.init(r), parseFloat(a.delay) && a.queue !== !1 && v.queue(r, a.queue, function (e) {
                    ...
                    b.mock !== !1 && (b.mock === !0 ? a.duration = a.delay = 1 : (a.duration *= parseFloat(b.mock) || 1, a.delay *= parseFloat(b.mock) || 1)), a.easing = u(a.easing, a.duration), a.begin && !h.isFunction(a.begin) && (a.begin = null), a.progress && !h.isFunction(a.progress) && (a.progress = null), a.complete && !h.isFunction(a.complete) && (a.complete = null), a.display !== n && null !== a.display && (a.display = a.display.toString().toLowerCase(), "auto" === a.display && (a.display = b.CSS.Values.getDisplayType(r))), a.visibility !== n && null !== a.visibility && (a.visibility = a.visibility.toString().toLowerCase()), a.mobileHA = a.mobileHA && b.State.isMobile && !b.State.isGingerbread, a.queue === !1 ? a.delay ? setTimeout(e, a.delay) : e() : v.queue(r, a.queue, function (t, i) {
                        return i === !0 ? (E.promise && E.resolver(m), !0) : (b.velocityQueueEntryFlag = !0, void e(t))
                    }), "" !== a.queue && "fx" !== a.queue || "inprogress" === v.queue(r)[0] || v.dequeue(r)
                }
                var l, d, p, m, y, w, s = arguments[0] && (arguments[0].p || v.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || h.isString(arguments[0].properties));
                if (h.isWrapped(this) ? (l = !1, p = 0, m = this, d = this) : (l = !0, p = 1, m = s ? arguments[0].elements || arguments[0].e : arguments[0]), m = a(m)) {
                    ...
                    if (!/^(stop|finish)$/i.test(y) && !v.isPlainObject(w)) {
                        var T = p + 1;
                        w = {};
                        for (var O = T; O < arguments.length; O++) h.isArray(arguments[O]) || !/^(fast|normal|slow)$/i.test(arguments[O]) && !/^\d/.test(arguments[O]) ? h.isString(arguments[O]) || h.isArray(arguments[O]) ? w.easing = arguments[O] : h.isFunction(arguments[O]) && (w.complete = arguments[O]) : w.duration = arguments[O]
                    }
                    var E = {
                        promise: null,
                        resolver: null,
                    ...
                    case "stop":
                        ...
                        var A = [];
                        return v.each(b.State.calls, function (e, t) {
                            t && v.each(t[1], function (i, r) {
                                var a = w === n ? "" : w;
                                return a === !0 || t[2].queue === a || w === n && t[2].queue === !1 ? void v.each(m, function (i, n) {
                                    n === r && ((w === !0 || h.isString(w)) && (v.each(v.queue(n, h.isString(w) ? w : ""), function (e, t) {
                                        h.isFunction(t) && t(null, !0)
                                    }), v.queue(n, h.isString(w) ? w : "", [])), "stop" === y ? (o(n) && o(n).tweensContainer && a !== !1 && v.each(o(n).tweensContainer, function (e, t) {
                                        t.endValue = t.currentValue
                                    }), A.push(e)) : "finish" === y && (t[2].duration = 1))
                                }) : !0
                            })
                        }), "stop" === y && (v.each(A, function (e, t) {
                            f(t, !0)
                        }), E.promise && E.resolver(m)), e();
                    default:
                        if (!v.isPlainObject(y) || h.isEmptyObject(y)) {
                            if (h.isString(y) && b.Redirects[y]) {
                                var $ = v.extend({}, w),
                                    M = $.duration,
                                    V = $.delay || 0;
                                return $.backwards === !0 && (m = v.extend(!0, [], m).reverse()), v.each(m, function (e, t) {
                                    parseFloat($.stagger) ? $.delay = V + parseFloat($.stagger) * e : h.isFunction($.stagger) && ($.delay = V + $.stagger.call(t, e, k)), $.drag && ($.duration = parseFloat(M) || (/^(callout|transition)/.test(y) ? 1e3 : g), $.duration = Math.max($.duration * ($.backwards ? 1 - e / k : (e + 1) / k), .75 * $.duration, 200)), b.Redirects[y].call(t, t, $ || {}, e, k, m, E.promise ? E : n)
                                }), e()
                            }
                    ...
                    var N, $ = v.extend({}, b.defaults, w);
                    if ($.loop = parseInt($.loop), N = 2 * $.loop - 1, $.loop)
                        for (var j = 0; N > j; j++) {
                            var z = {
                                delay: $.delay,
                                progress: $.progress
                            };
                            j === N - 1 && (z.display = $.display, z.visibility = $.visibility, z.complete = $.complete), C(m, "reverse", z)
                        }
                    return e()
                }
            };
            ...
            }), e.Velocity = b, e !== t && (e.fn.velocity = C, e.fn.velocity.defaults = b.defaults), v.each(["Down", "Up"], function (e, t) {
    ...
    function (e) {
        e(document).ready(function () {
            e.fn.reverse = [].reverse, e(document).on("mouseenter.fixedActionBtn", ".fixed-action-btn", function (i) {
                var n = e(this);
                t(n)
        ...
        var t = function (t) {
            ...
            i = function (e) {
                $this = e, $this.removeClass("active");
    ...
    function (e) {
        ...
        function r(e) {
            return n(e) ? e : 9 === e.nodeType && e.defaultView
        }
        ...
        function a(e) {
            var t, i, n = {
                ...
                a = e && e.ownerDocument;
            return t = a.documentElement, "undefined" != typeof e.getBoundingClientRect && (n = e.getBoundingClientRect()), i = r(a), {
        ...
        function c(t) {
            var i = u(t);
            null !== i && (s.show(t, i), "ontouchstart" in e && (i.addEventListener("touchend", s.hide, !1), i.addEventListener("touchcancel", s.hide, !1)), i.addEventListener("mouseup", s.hide, !1), i.addEventListener("mouseleave", s.hide, !1))
        }
        var t = t || {},
            ...
            s = {
                ...
                show: function (e, t) {
                    ...
                    "touches" in e && (l = e.touches[0].pageY - r.top, u = e.touches[0].pageX - r.left), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-scale", c), n.setAttribute("data-x", u), n.setAttribute("data-y", l);
                    var f = {
                        top: l + "px",
                        left: u + "px"
                    };
                    n.className = n.className + " waves-notransition", n.setAttribute("style", o(f)), n.className = n.className.replace("waves-notransition", ""), f["-webkit-transform"] = c, f["-moz-transform"] = c, f["-ms-transform"] = c, f["-o-transform"] = c, f.transform = c, f.opacity = "1", f["-webkit-transition-duration"] = s.duration + "ms", f["-moz-transition-duration"] = s.duration + "ms", f["-o-transition-duration"] = s.duration + "ms", f["transition-duration"] = s.duration + "ms", f["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", f["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", f["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", f["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", n.setAttribute("style", o(f))
                },
                hide: function (e) {
                    l.touchup(e);
                    var t = this,
                    ...
                    var a = n.getAttribute("data-x"),
                        u = n.getAttribute("data-y"),
                        c = n.getAttribute("data-scale"),
                        f = Date.now() - Number(n.getAttribute("data-hold")),
                        d = 350 - f;
                    0 > d && (d = 0), setTimeout(function () {
                        ...
                        n.setAttribute("style", o(e)), setTimeout(function () {
                            try {
                                t.removeChild(n)
                            } catch (e) {
                                return !1
        ...
        t.displayEffect = function (t) {
            t = t || {}, "duration" in t && (s.duration = t.duration), s.wrapInput(i(".waves-effect")), "ontouchstart" in e && document.body.addEventListener("touchstart", c, !1), document.body.addEventListener("mousedown", c, !1)
        }, t.attach = function (t) {
            "input" === t.tagName.toLowerCase() && (s.wrapInput([t]), t = t.parentElement), "ontouchstart" in e && t.addEventListener("touchstart", c, !1), t.addEventListener("mousedown", c, !1)
